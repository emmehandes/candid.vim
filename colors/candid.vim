...
" Repository:   https://github.com/emmehandes/candid.vim
...
call  <sid>hi('VertSplit',     s:raisin_black,  s:raisin_black,  'none',  {})
call  <sid>hi('LineNr',        s:mustard,       s:raisin_black,  'none',  {})
...
call  <sid>hi('StatusLineNC',  s:raisin_black,  s:raisin_black,  'none',  {})
