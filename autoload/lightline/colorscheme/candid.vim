...
" Author: Elie M, updated from Florian Rand
" License: MIT License
" =============================================================================
...
let s:p.normal.left    = [ [ s:isabelline, s:raisin_black ], [ s:sea_serpent, s:raisin_black ] ]
let s:p.normal.middle  = [ [ s:isabelline, s:raisin_black ] ]
let s:p.normal.right   = [ [ s:blue_bell, s:raisin_black ],  [ s:sea_serpent, s:raisin_black ] ]
...
let s:p.insert.right   = [ [ s:blue_bell, s:raisin_black ],  [ s:eucalyptus, s:raisin_black ] ]

let s:p.replace.left = [ [ s:raisin_black, s:tickle_me_pink ], [ s:tickle_me_pink, s:raisin_black ] ]
let s:p.replace.right   = [ [ s:blue_bell, s:raisin_black ],  [ s:tickle_me_pink, s:raisin_black ] ]
